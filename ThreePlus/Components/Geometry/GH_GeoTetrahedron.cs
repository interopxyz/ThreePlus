...
{
    public class GH_GeoTetrahedron : GH_GeoPreview
    {
        /// <summary>
        /// Initializes a new instance of the GH_GeoTetrahedron class.
        /// </summary>
        public GH_GeoTetrahedron()
          : base("Tetrahedron Geometry", "Tetrahedron",
              "A Three JS Standard Geometry Tetrahedron",
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            Shape shape = Shape.TetrahedronShape(plane, radius);
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                ...
                return Properties.Resources.Three_Shape_Tetrahedron_01;
            }
        }
        ...
        {
            get { return new Guid("9d7adedd-37b3-44e6-a74d-10110b538693"); }
        }
    }
}