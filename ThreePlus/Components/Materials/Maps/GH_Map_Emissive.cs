...
namespace ThreePlus.Components.Materials.Maps
{
    public class GH_Map_Emissive : GH_Component
    {
        ...
        protected override void RegisterInputParams(GH_Component.GH_InputParamManager pManager)
        {
            ...
            pManager.AddGenericParameter("Emissive Map", "Em", "Set emisssive (glow) map. The emissive map color is modulated by the emissive color and the emissive intensity. If you have an emissive map, be sure to set the emissive color to something other than black." + System.Environment.NewLine + "(A System Drawing Bitmap or full filepath to an image.)", GH_ParamAccess.item);
            ...
            pManager.AddColourParameter("Emissive Color", "Ec", "Emissive (light) color of the material, essentially a solid color unaffected by other lighting.", GH_ParamAccess.item);
