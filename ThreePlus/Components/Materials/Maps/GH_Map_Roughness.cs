...
namespace ThreePlus.Components.Materials.Maps
{
    public class GH_Map_Roughness : GH_Component
    {
        ...
        protected override void RegisterInputParams(GH_Component.GH_InputParamManager pManager)
        {
            ...
            pManager.AddGenericParameter("Roughness Map", "Img", "The green channel of this texture is used to alter the roughness of the material." + System.Environment.NewLine + "(A System Drawing Bitmap or full filepath to an image.)", GH_ParamAccess.item);
